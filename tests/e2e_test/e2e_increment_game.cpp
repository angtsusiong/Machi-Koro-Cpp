...
class TestIncrementGame : public ::testing::Test {
protected:
    void SetUp() override
    {
        Json::Value req_body;
        ...
        Json::Value req2_body;
        auto req2 = drogon::HttpRequest::newHttpJsonRequest(req2_body);
...
TEST_F(TestIncrementGame, GivenInitGame_IncrementCurrentPlayer)
{
    Json::Value req_body;

    auto req = drogon::HttpRequest::newHttpJsonRequest(req_body);
    req->setMethod(drogon::HttpMethod::Post);
    req->setPath("/IncrementGame/" + game_id_);
