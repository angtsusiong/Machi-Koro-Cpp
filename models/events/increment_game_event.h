#ifndef MODELS_EVENTS_INCREMENT_GAME_EVENT_H
#define MODELS_EVENTS_INCREMENT_GAME_EVENT_H
...
class IncrementGameEvent : public Event {
public:
    IncrementGameEvent() = default;
...
#endif  // MODELS_EVENTS_INCREMENT_GAME_EVENT_H